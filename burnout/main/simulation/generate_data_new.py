...
for employee in employees:
    for day in range(num_days):
        ...
        message_tone = np.random.choice(['Позитивное', 'Нейтральное', 'Негативное'], p=[0.1, 0.2, 0.7])
        ...
        commit_regularity = np.random.randint(1, 3)
        ...
        task_priority_changes = np.random.randint(3, 6)
